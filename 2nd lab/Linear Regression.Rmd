...
Para responder essa questão, farei um modelo otimizado para cada período, utilizando somente as disciplinas boas preditoras e depois irei comparar os modelos.
...
Podemos verificar que ambos os modelos possuem variáveis preditoras com p-valores muito alto. Isto é, algumas variáveis não explicam bem o cra. Para podermos comparar melhor os modelos dos períodos vamos melhorá-los usando os algoritmos de seleção de variáveis.
...
Dentre os três, o modelo para o segundo período é o que melhor prevê o cra.
...
O resultado da previsão do modelo do segundo semestre, que havia sido o melhor entre os três foi muito próxima do meu CRA. O meu CRA é 8,78 e o modelo previu 8.65. O interessante é que dos três modelos, o que previu o melhor resultado foi o modelo que utiliza ambos os semestres, que previu 8.77. Mas como estamos avaliando somente um único valor de previsão, não podemos afirmar que o modelo de ambos os semestres sempre irá prever melhor. Talvez tenha sido somente para um caso isolado. De qualquer forma, seria necessário mais ajustes do que simplesmente olhar para o RSE, os p-valores e o r² ajustado para termos a certeza de um modelo mais exato. Mas como esta é uma atividade introdutória à regressão linear e ajuste de modelos, não se pode ir muito além nas técnicas de ajuste do modelo.