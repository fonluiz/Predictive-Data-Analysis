...
Agora vamos comparar os dois modelos encontrados: o modelo com todas as variáveis e o modelo com seis variáveis apenas.
```{r}
p.values.first.model <- summary(cra.model.fit)$coefficients[,4]
p.values.best.model <- summary(cra.best.fit)$coefficients[,4]

adjr2.first.model <- summary(cra.model.fit)$adj.r.squared
